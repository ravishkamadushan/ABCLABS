    ...
    public partial class DoctorListing : System.Web.UI.Page
    {
        ...
        private void showServiceList()
        {
            if (dt == null)
            {
                ...
                string query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate from Doctors";
        ...
        protected void ddlDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                con = new SqlConnection(str);
                string query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate 
                from Doctors where District ='" + ddlDistrict.SelectedValue + "' ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void CheckBoxList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (serviceType != "")
            {
                con = new SqlConnection(str);
                string query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate 
                from Doctors where ServiceType IN (" + serviceType + ")";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (RadioButtonList1.SelectedValue != "0")
            {
                ...
                con = new SqlConnection(str);
                string query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate 
                from Doctors where Convert(DATE,CreateDate) " + postedDate + " ";
                cmd = new SqlCommand(query, con);
                sda = new SqlDataAdapter(cmd);
                dt = new DataTable();
                sda.Fill(dt);
        ...
        protected void lbFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddlDistrict.SelectedValue != "0")
                {
                    queryList.Add("District = '" + ddlDistrict.SelectedValue + "' ");
                    isCondition = true;
                }
                serviceType = selectedCheckBox();
                ...
                if (serviceType != "")
                {
                    queryList.Add("ServiceType IN (" + serviceType + ")");
                    isCondition = true;
                }
                if (RadioButtonList1.SelectedValue != "0")
                {
                ...
                if (isCondition)
                {
                    ...
                    query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate from Doctors where " + subquery + " ";
                }
                else
                {
                    query = @"Select ServiceId,Title,Fee,ServiceType,CompanyName,CompanyImage,District,ContactNo,CreateDate from Doctors";
                }
