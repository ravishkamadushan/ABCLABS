                ...
                <div class="row d-flex justify-contnet-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Physiotheraphy</a></h5>
                                <span>(653)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Cardiologist</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Dermotologist</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">NEURO SURGERY</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Information Technology</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Real Estate</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="ServiceListing.aspx">Content Writer</a></h5>
                                <span>(658)</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="Servicelisting.aspx" class="border-btn2">Browse All Sectors</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="right-caption">
                            ...
                            <div class="support-caption">
                                <p class="pera-top">
                                    Thousands of skilled healthcare professionals are finding rewarding positions.
                                                Our hospital is dedicated to providing compassionate care and exceptional service to our patients.
                                </p>
                                <p>
